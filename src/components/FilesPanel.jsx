...
export default function FilesPanel({ video, openVideo, removeVideo, makeProxy, proxyProgress, cancelProxy, decodeBlackbox, decoding, busy, bbOptions, setBbOptions, store, storeVersion, addCsvFiles, updateSource, removeSource, removeAllSources }) {
  void storeVersion;
